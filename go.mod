...
require (
	...
	github.com/yandex-cloud/terraform-provider-yandex v0.150.0
...
require (
	...
	github.com/yandex-cloud/go-genproto v0.16.0 // indirect
	...
	github.com/ydb-platform/terraform-provider-ydb v0.0.26 // indirect
