...
import (
	...
	"github.com/yandex-cloud/crossplane-provider-yc/config/cluster/compute"
	"github.com/yandex-cloud/crossplane-provider-yc/config/cluster/vpc"
)

const (
	// ApisPackagePath is the golang path for this package.
	ApisPackagePath       = "github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/lb/v1alpha1"
	ConfigPath            = "github.com/yandex-cloud/crossplane-provider-yc/config/cluster/nlb"
