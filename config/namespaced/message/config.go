...
func Configure(p *config.Provider) {
	p.AddResourceConfigurator("yandex_message_queue", func(r *config.Resource) {
...
const (
	...
	APISPackagePath = "github.com/yandex-cloud/crossplane-provider-yc/config/namespaced/message"
