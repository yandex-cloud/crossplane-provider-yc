...
const (
	...
	ApisPackagePath = "github.com/yandex-cloud/crossplane-provider-yc/apis/namespaced/resourcemanager/v1alpha1"
	// FolderType is the full type reference for Folder resource
	FolderType = ApisPackagePath + ".Folder"
)
