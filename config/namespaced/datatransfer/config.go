...
import (
	...
	"github.com/yandex-cloud/crossplane-provider-yc/config/namespaced/mdb"
...
const (
	...
	APISPackagePath = "github.com/yandex-cloud/crossplane-provider-yc/config/namespaced/datatransfer"
