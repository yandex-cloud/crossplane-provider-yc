...
const (
	...
	ApisPackagePath = "github.com/yandex-cloud/crossplane-provider-yc/apis/namespaced/iam/v1alpha1"
	// ConfigPath is the golang path for this package.
	ConfigPath = "github.com/yandex-cloud/crossplane-provider-yc/config/namespaced/iam"
