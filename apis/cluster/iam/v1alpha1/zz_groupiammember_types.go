...
type GroupIAMMemberObservation struct {
	...
	// (String). The ID of the group to attach the policy to.
...
// GroupIAMMember is the Schema for the GroupIAMMembers API. Manages the yandex_organizationmanager_group_iam_member resource.
