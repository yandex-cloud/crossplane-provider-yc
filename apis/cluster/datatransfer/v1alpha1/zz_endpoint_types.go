...
type MongoSourceConnectionConnectionOptionsInitParameters struct {
	...
	// Use one of:  mdb_cluster_id/on_premise/connection_manager_connection
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.MongodbCluster
	MdbClusterID *string `json:"mdbClusterId,omitempty" tf:"mdb_cluster_id,omitempty"`
...
type MySQLSourceConnectionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.MySQLCluster
	MdbClusterID *string `json:"mdbClusterId,omitempty" tf:"mdb_cluster_id,omitempty"`
...
type MySQLSourceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.MySQLDatabase
	// +crossplane:generate:reference:extractor=github.com/yandex-cloud/crossplane-provider-yc/config/cluster/datatransfer.ExtractSpecName()
	Database *string `json:"database,omitempty" tf:"database,omitempty"`
	...
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.MySQLUser
	// +crossplane:generate:reference:extractor=github.com/yandex-cloud/crossplane-provider-yc/config/cluster/datatransfer.ExtractSpecName()
	User *string `json:"user,omitempty" tf:"user,omitempty"`
...
type PostgresSourceConnectionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.PostgresqlCluster
	MdbClusterID *string `json:"mdbClusterId,omitempty" tf:"mdb_cluster_id,omitempty"`
...
type PostgresSourceInitParameters struct {
	...
	// transfer
	// Name of the database to transfer
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.PostgresqlDatabase
	// +crossplane:generate:reference:extractor=github.com/yandex-cloud/crossplane-provider-yc/config/cluster/datatransfer.ExtractSpecName()
	Database *string `json:"database,omitempty" tf:"database,omitempty"`
	...
	// (String). User name
	// User for database access. Required unless Connection Manager connection is used.
	// +crossplane:generate:reference:type=github.com/yandex-cloud/crossplane-provider-yc/apis/cluster/mdb/v1alpha1.PostgresqlUser
	// +crossplane:generate:reference:extractor=github.com/yandex-cloud/crossplane-provider-yc/config/cluster/datatransfer.ExtractSpecName()
	User *string `json:"user,omitempty" tf:"user,omitempty"`
