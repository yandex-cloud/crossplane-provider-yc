...
func (tr *DiskPlacementGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *DiskPlacementGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *DiskPlacementGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *DiskPlacementGroup) SetParameters(params map[string]interface{}) error {
