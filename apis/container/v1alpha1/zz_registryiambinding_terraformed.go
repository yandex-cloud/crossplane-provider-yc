...
func (tr *RegistryIamBinding) GetObservation() (map[string]interface{}, error) {
...
func (tr *RegistryIamBinding) SetObservation(obs map[string]interface{}) error {
...
func (tr *RegistryIamBinding) GetParameters() (map[string]interface{}, error) {
...
func (tr *RegistryIamBinding) SetParameters(params map[string]interface{}) error {
