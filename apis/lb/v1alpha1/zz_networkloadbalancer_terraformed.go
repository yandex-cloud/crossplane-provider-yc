...
func (tr *NetworkLoadBalancer) GetObservation() (map[string]interface{}, error) {
...
func (tr *NetworkLoadBalancer) SetObservation(obs map[string]interface{}) error {
...
func (tr *NetworkLoadBalancer) GetParameters() (map[string]interface{}, error) {
...
func (tr *NetworkLoadBalancer) SetParameters(params map[string]interface{}) error {
