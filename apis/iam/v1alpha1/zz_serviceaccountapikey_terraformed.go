...
func (tr *ServiceAccountApiKey) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServiceAccountApiKey) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServiceAccountApiKey) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServiceAccountApiKey) SetParameters(params map[string]interface{}) error {
