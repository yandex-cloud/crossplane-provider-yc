...
type ServiceAccountKeyObservation struct {
	...
	// Only) (String). The encrypted private key, base64 encoded. This is only populated when pgp_key is supplied.
	...
	// Only) (String). The fingerprint of the PGP key used to encrypt the private key. This is only populated when pgp_key is supplied.
...
// ServiceAccountKey is the Schema for the ServiceAccountKeys API. Manages the yandex_iam_service_account_key resource.
