...
// SAMLFederationUserAccount is the Schema for the SAMLFederationUserAccounts API. Manages the yandex_organizationmanager_saml_federation_user_account resource.
