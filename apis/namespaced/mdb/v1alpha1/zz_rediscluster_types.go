...
type RedisClusterAccessInitParameters struct {
	...
	// (Bool). Allow access for DataLens. Can be either true or false.
	// Allow access for DataLens. Can be either `true` or `false`.
	DataLens *bool `json:"dataLens,omitempty" tf:"data_lens,omitempty"`

	// (Bool). Allow access for Web SQL. Can be either true or false.
...
type RedisClusterConfigInitParameters struct {
	...
	// (Bool). Allows some data to be lost in favor of faster switchover/restart by RDSync.
	...
	// (Bool). Controls whether all hash slots must be covered by nodes.
	...
	// (String). Password for the Redis cluster.
	...
	// Password for the Redis cluster. This attribute is write-only and is not stored in state. Requires `password_wo_version` to trigger updates.11 or higher.
	...
	// (Bool). Allows to turn before switchover in RDSync.
	...
	// (Bool). Use JIT for lua scripts and functions.
...
type RedisClusterHostInitParameters struct {
	...
	// (Bool). Sets whether the host should get a public IP address or not.
...
type RedisClusterInitParameters struct {
	...
	// [Block]. Configuration of the Redis cluster.
	...
	// [Block]. Disk size autoscaling settings.
	...
	// [Block]. A host of the Redis cluster.
	...
	// [Block]. Maintenance window settings.
	...
	// [Block]. Resources allocated to hosts of the Redis cluster.
	...
	// (Bool). TLS support mode enabled/disabled.
...
// RedisCluster is the Schema for the RedisClusters API. Manages the yandex_mdb_redis_cluster resource.
