...
type ConfigKafkaInitParameters struct {
	...
	// defined settings for the Kafka cluster. For more information, see the official documentation and the Kafka documentation.
	...
	// [Block]. Resources allocated to hosts of the Kafka subcluster.
...
type KafkaClusterConfigInitParameters struct {
	...
	// [Block]. Access policy to the Kafka cluster.
	...
	// [Block]. Disk autoscaling settings of the Kafka cluster.
...
type KafkaClusterConfigObservation struct {
	...
	// Only) (String). Patch version of the Kafka server software.
...
type KafkaClusterInitParameters struct {
	...
	// [Block]. Configuration of the Kafka cluster.
	...
	// [Block]. Maintenance policy of the Kafka cluster.
	...
	// [Block]. To manage topics, please switch to using a separate resource type yandex_mdb_kafka_topic.
	...
	// [Block]. To manage users, please switch to using a separate resource type yandex_mdb_kafka_user.
...
type KafkaClusterObservation struct {
	...
	// Only) (Set Of Object). A host of the Kafka cluster.
...
type KafkaConfigInitParameters struct {
	...
	// (Bool). Enable auto creation of topic on the server.
	...
	// (String). Defines whether the timestamp in a message is the message creation time or the log append time. Possible values are MESSAGE_TIMESTAMP_TYPE_CREATE_TIME and MESSAGE_TIMESTAMP_TYPE_LOG_APPEND_TIME.
	// Defines whether the timestamp in a message is the message creation time or the log append time. Possible values are `MESSAGE_TIMESTAMP_TYPE_CREATE_TIME` and `MESSAGE_TIMESTAMP_TYPE_LOG_APPEND_TIME`.
	LogMessageTimestampType *string `json:"logMessageTimestampType,omitempty" tf:"log_message_timestamp_type,omitempty"`

	// (Bool). Should pre allocate file when create new segment?
	...
	// (String). Timeout for transactional ids to expire in ms.
	// Timeout for transactional ids to expire in ms.
	TransactionalIDExpirationMs *string `json:"transactionalIdExpirationMs,omitempty" tf:"transactional_id_expiration_ms,omitempty"`
}
...
type KafkaUIInitParameters struct {
	...
	// (Bool). Enables KAFKA UI on cluster. The default is false.
...
type TopicConfigInitParameters struct {
	...
	// (Bool). True if we should preallocate the file on disk when creating a new log segment.
...
type TopicInitParameters struct {
	...
	// defined settings for the topic. For more information, see the official documentation and the Kafka documentation.
...
// KafkaCluster is the Schema for the KafkaClusters API. Manages the yandex_mdb_kafka_cluster resource.
