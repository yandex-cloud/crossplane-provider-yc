...
func (tr *ClickhouseCluster) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"admin_password": "adminPasswordSecretRef", "admin_password_wo": "adminPasswordWoSecretRef", "clickhouse[*].config[*].kafka[*].sasl_password": "clickhouse[*].config[*].kafka[*].saslPasswordSecretRef", "clickhouse[*].config[*].kafka_topic[*].settings[*].sasl_password": "clickhouse[*].config[*].kafkaTopic[*].settings[*].saslPasswordSecretRef", "clickhouse[*].config[*].rabbitmq[*].password": "clickhouse[*].config[*].rabbitmq[*].passwordSecretRef", "user[*].password": "user[*].passwordSecretRef"}
}
