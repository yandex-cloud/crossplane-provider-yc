...
type AccessInitParameters struct {
	...
	// (Bool). Allow access for Yandex.Metrika.
...
type ClickhouseClusterInitParameters struct {
	...
	// [Block]. Access policy to the ClickHouse cluster.
	// Access policy to the ClickHouse cluster.
	Access []AccessInitParameters `json:"access,omitempty" tf:"access,omitempty"`

	// (String). A password used to authorize as user admin when sql_user_management enabled.
	...
	// only and is not stored in state. Requires admin_password_wo_version to trigger updates.11 or higher.
	// A password used to authorize as user `admin` when `sql_user_management` enabled. This attribute is write-only and is not stored in state. Requires `admin_password_wo_version` to trigger updates.11 or higher.
	AdminPasswordWoSecretRef *v1.LocalSecretKeySelector `json:"adminPasswordWoSecretRef,omitempty" tf:"-"`
	...
	AdminPasswordWoVersion *float64 `json:"adminPasswordWoVersion,omitempty" tf:"admin_password_wo_version,omitempty"`
	...
	// [Block]. Configuration of the ClickHouse subcluster.
	...
	// (Bool). Whether to copy schema on new ClickHouse hosts.
	...
	// [Block]. A database of the ClickHouse cluster.
	...
	// (Bool). Whether to use ClickHouse Keeper as a coordination system and place it on the same hosts with ClickHouse. If not, it's used ZooKeeper with placement on separate hosts.
	...
	// [Block]. A set of protobuf or capnproto format schemas.
	...
	// [Block]. A group of machine learning models.
	...
	// (Bool). Grants admin user database management permission.
	...
	// (Bool). Enables admin user with user management permission.
	...
	// [Block]. Configuration of the ZooKeeper subcluster.
...
type ClickhouseClusterObservation struct {
	...
	// Only) (String). Aggregated health of the cluster. Can be ALIVE, DEGRADED, DEAD or HEALTH_UNKNOWN. For more information see health field of JSON representation in the official documentation.
	...
	// Only) (String). Status of the cluster. Can be CREATING, STARTING, RUNNING, UPDATING, STOPPING, STOPPED, ERROR or STATUS_UNKNOWN. For more information see status field of JSON representation in the official documentation.
...
type ClickhouseInitParameters struct {
	...
	// [Block]. ClickHouse server parameters. For more information, see the official documentation.
	...
	// [Block]. Resources allocated to hosts of the ClickHouse subcluster.
...
type CloudStorageInitParameters struct {
	...
	// (Bool). Enables temporary storage in the cluster repository of data requested from the object repository.
	...
	// (Bool). Whether to use Yandex Object Storage for storing ClickHouse data. Can be either true or false.
	...
	// (Bool). Disables merging of data parts in Yandex Object Storage.
...
type ConfigInitParameters struct {
	...
	// (Bool). Enable or disable asynchronous_insert_log system table.
	...
	// (Bool). Enable or disable asynchronous_metric_log system table.
	...
	// [Block]. Data compression configuration.
	...
	// (Bool). Lazy loading of dictionaries. If true, then each dictionary is loaded on the first use.
	...
	// (Bool). Enable or disable geobase.
	...
	// [Block]. Graphite rollup configuration.
	...
	// (Bool). Enable or disable opentelemetry_span_log system table.
	...
	// [Block]. Query cache configuration.
	...
	// [Block]. Query masking rules configuration.
	...
	// (Bool). Enable or disable query_thread_log system table.
	...
	// (Bool). Enable or disable query_views_log system table.
	...
	// [Block]. RabbitMQ connection configuration.
	// RabbitMQ connection configuration.
	Rabbitmq []RabbitmqInitParameters `json:"rabbitmq,omitempty" tf:"rabbitmq,omitempty"`

	// (Bool). Enable or disable session_log system table.
	...
	// (Bool). Enable or disable text_log system table.
	...
	// (Bool). Enable or disable trace_log system table.
	...
	// (Bool). Enable or disable zookeeper_log system table.
...
type FormatSchemaInitParameters struct {
	...
	// (String). Type of the format schema.
...
type HostInitParameters struct {
	...
	// (Bool). Sets whether the host should get a public IP address on creation. Can be either true or false.
...
type KafkaInitParameters struct {
	...
	// (Bool). Enable verification of SSL certificates.
	...
	// (String). User password on kafka server.
...
type KafkaTopicInitParameters struct {
	...
	// [Block]. Kafka connection settings.
...
type MergeTreeInitParameters struct {
	...
	// (Bool). When this setting has a value greater than zero only a single replica starts the merge immediately if merged part on shared storage and allow_remote_fs_zero_copy_replication is enabled.
	...
	// (Bool). Enables the check at table creation, that the data type of a column for sampling or sampling expression is correct. The data type must be one of unsigned integer types: UInt8, UInt16, UInt32, UInt64. Default value: true.
	...
	// (Bool). Whether min_age_to_force_merge_seconds should be applied only on the entire partition and not on subset.
...
type UserInitParameters struct {
	...
	// (Bool). Generate password using Connection Manager. Allowed values: true or false. It's used only during user creation and is ignored during updating.
...
type UserObservation struct {
	...
	// Only) (Map Of String). Connection Manager connection configuration. Filled in by the server automatically.
...
type UserSettingsInitParameters struct {
	...
	// (Bool). Include CORS headers in HTTP responses.
	...
	// (Bool). Allows or denies DDL queries.
	// Allows or denies DDL queries.
	AllowDdl *bool `json:"allowDdl,omitempty" tf:"allow_ddl,omitempty"`

	// (Bool). Enables introspections functions for query profiling.
	...
	// (Bool). Allows specifying LowCardinality modifier for types of small fixed size (8 or less) in CREATE TABLE statements. Enabling this may increase merge times and memory consumption.
	...
	// (Bool). Enables legacy ClickHouse server behavior in ANY INNER|LEFT JOIN operations.
	...
	// (Bool). Enables asynchronous inserts. Disabled by default.
	...
	// (Bool). If it is set to true, use adaptive busy timeout for asynchronous inserts.
	...
	// (Bool). Allows data types without explicit modifiers NULL or NOT NULL in column definition will be Nullable.
	...
	// (Bool). Enables or disables the deduplication check for materialized views that receive data from Replicated tables.
	...
	// (Bool). Determine the behavior of distributed subqueries.
	...
	// (Bool). Enable or disable independent processing of partitions for SELECT queries with FINAL.
	...
	// (Bool). Allows to return empty result.
	...
	// (Bool). If turned on, results of SELECT queries are stored in the query cache.
	...
	// (Bool). Skip lines unmatched by regular expression.
	...
	// (Bool). Ignore materialized views with dropped target table during pushing to views.
	...
	// (Bool). When performing INSERT queries, replace omitted input column values with default values of the respective columns.
	...
	// (Bool). Enables or disables the insertion of JSON data with nested objects.
	...
	// (Bool). Enables or disables the initialization of NULL fields with default values, if data type of these fields is not nullable.
	...
	// (Bool). Enables or disables the full SQL parser if the fast stream parser can’t parse the data.
	...
	// (Bool). Enables or disables checking the column order when inserting data.
	...
	// (Bool). Enables the insertion of default values instead of NULL into columns with not nullable data type. Default value: true.
	...
	// (Bool). Enables or disables parallelism for quorum INSERT queries.
	...
	// (Bool). Sets the type of JOIN behavior. When merging tables, empty cells may appear. ClickHouse fills them differently based on this setting.
	...
	// (Bool). Require aliases for subselects and table functions in FROM that more than one table is present.
	...
	// (Bool). Enabled or disable logging of processors level profiling data to the the system.processors_profile_log table.
	...
	// (Bool). Setting up query threads logging. Query threads log into the system.query_thread_log table. This setting has effect only when log_queries is true. Queries’ threads run by ClickHouse with this setup are logged according to the rules in the query_thread_log server configuration parameter. Default value: true.
	...
	// (Bool). Enables or disables query views logging to the the system.query_views_log table.
	...
	// (Bool). Allows or restricts using the LowCardinality data type with the Native format.
	...
	// (Bool). If the value is true, integers appear in quotes when using JSON* Int64 and UInt64 formats (for compatibility with most JavaScript implementations); otherwise, integers are output without the quotes.
	...
	// (Bool). Enables/disables preferable using the localhost replica when processing distributed queries. Default value: true.
	...
	// (Bool). If turned on, the result of SELECT queries cached in the query cache can be read by other users. It is not recommended to enable this setting due to security reasons.
	...
	// (Bool). Enables or disables adaptive timeouts for S3 requests.
	...
	// (Bool). Enables or disables sequential consistency for SELECT queries.
	...
	// (Bool). Enables or disables silently skipping of unavailable shards.
	...
	// (Bool). Enables equality of NULL values for IN operator.
	// Enables equality of NULL values for IN operator.
	TransformNullIn *bool `json:"transformNullIn,omitempty" tf:"transform_null_in,omitempty"`

	// (Bool). Enables hedged requests logic for remote queries. It allows to establish many connections with different replicas for query. New connection is enabled in case existent connection(s) with replica(s) were not established within hedged_connection_timeout or no data was received within receive_data_timeout. Query uses the first connection which send non empty progress packet (or data packet, if allow_changing_replica_until_first_data_packet); other connections are cancelled. Queries with max_parallel_replicas > 1 are supported. Default value: true.
	...
	// (Bool). If turned on, SELECT queries may utilize the query cache.
	...
	// (Bool). Whether to use a cache of uncompressed blocks.
	...
	// (Bool). Enables waiting for processing of asynchronous insertion. If enabled, server returns OK only after the data is inserted.
...
// ClickhouseCluster is the Schema for the ClickhouseClusters API. Manages the yandex_mdb_clickhouse_cluster resource.
