...
import (
	...
	v1alpha11 "github.com/yandex-cloud/crossplane-provider-yc/apis/namespaced/iam/v1alpha1"
	v1alpha1 "github.com/yandex-cloud/crossplane-provider-yc/apis/namespaced/resourcemanager/v1alpha1"
	v1alpha12 "github.com/yandex-cloud/crossplane-provider-yc/apis/namespaced/vpc/v1alpha1"
	iam "github.com/yandex-cloud/crossplane-provider-yc/config/namespaced/iam"
...
// ResolveReferences of this DiskIAMBinding.
func (mg *DiskIAMBinding) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
