...
func (in *NodeGroupInitParameters) DeepCopyInto(out *NodeGroupInitParameters) {
	*out = *in
	...
	if in.WorkloadIdentityFederation != nil {
		in, out := &in.WorkloadIdentityFederation, &out.WorkloadIdentityFederation
		*out = make([]NodeGroupWorkloadIdentityFederationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeGroupObservation) DeepCopyInto(out *NodeGroupObservation) {
	*out = *in
	...
	if in.WorkloadIdentityFederation != nil {
		in, out := &in.WorkloadIdentityFederation, &out.WorkloadIdentityFederation
		*out = make([]NodeGroupWorkloadIdentityFederationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeGroupParameters) DeepCopyInto(out *NodeGroupParameters) {
	*out = *in
	...
	if in.WorkloadIdentityFederation != nil {
		in, out := &in.WorkloadIdentityFederation, &out.WorkloadIdentityFederation
		*out = make([]NodeGroupWorkloadIdentityFederationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeGroupWorkloadIdentityFederationInitParameters) DeepCopyInto(out *NodeGroupWorkloadIdentityFederationInitParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeGroupWorkloadIdentityFederationInitParameters.
func (in *NodeGroupWorkloadIdentityFederationInitParameters) DeepCopy() *NodeGroupWorkloadIdentityFederationInitParameters {
	if in == nil {
		return nil
	}
	out := new(NodeGroupWorkloadIdentityFederationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeGroupWorkloadIdentityFederationObservation) DeepCopyInto(out *NodeGroupWorkloadIdentityFederationObservation) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeGroupWorkloadIdentityFederationObservation.
func (in *NodeGroupWorkloadIdentityFederationObservation) DeepCopy() *NodeGroupWorkloadIdentityFederationObservation {
	if in == nil {
		return nil
	}
	out := new(NodeGroupWorkloadIdentityFederationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeGroupWorkloadIdentityFederationParameters) DeepCopyInto(out *NodeGroupWorkloadIdentityFederationParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeGroupWorkloadIdentityFederationParameters.
func (in *NodeGroupWorkloadIdentityFederationParameters) DeepCopy() *NodeGroupWorkloadIdentityFederationParameters {
	if in == nil {
		return nil
	}
	out := new(NodeGroupWorkloadIdentityFederationParameters)
	in.DeepCopyInto(out)
	return out
}
