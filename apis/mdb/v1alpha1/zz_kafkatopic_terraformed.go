...
func (tr *KafkaTopic) GetObservation() (map[string]interface{}, error) {
...
func (tr *KafkaTopic) SetObservation(obs map[string]interface{}) error {
...
func (tr *KafkaTopic) GetParameters() (map[string]interface{}, error) {
...
func (tr *KafkaTopic) SetParameters(params map[string]interface{}) error {
