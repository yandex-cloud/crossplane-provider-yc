...
func (tr *GreenplumCluster) GetObservation() (map[string]interface{}, error) {
...
func (tr *GreenplumCluster) SetObservation(obs map[string]interface{}) error {
...
func (tr *GreenplumCluster) GetParameters() (map[string]interface{}, error) {
...
func (tr *GreenplumCluster) SetParameters(params map[string]interface{}) error {
