...
func (tr *SqlserverCluster) GetObservation() (map[string]interface{}, error) {
...
func (tr *SqlserverCluster) SetObservation(obs map[string]interface{}) error {
...
func (tr *SqlserverCluster) GetParameters() (map[string]interface{}, error) {
...
func (tr *SqlserverCluster) SetParameters(params map[string]interface{}) error {
