...
func (tr *SymmetricKeyIamBinding) GetObservation() (map[string]interface{}, error) {
...
func (tr *SymmetricKeyIamBinding) SetObservation(obs map[string]interface{}) error {
...
func (tr *SymmetricKeyIamBinding) GetParameters() (map[string]interface{}, error) {
...
func (tr *SymmetricKeyIamBinding) SetParameters(params map[string]interface{}) error {
