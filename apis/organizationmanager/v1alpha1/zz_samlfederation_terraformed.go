...
func (tr *SamlFederation) GetObservation() (map[string]interface{}, error) {
...
func (tr *SamlFederation) SetObservation(obs map[string]interface{}) error {
...
func (tr *SamlFederation) GetParameters() (map[string]interface{}, error) {
...
func (tr *SamlFederation) SetParameters(params map[string]interface{}) error {
