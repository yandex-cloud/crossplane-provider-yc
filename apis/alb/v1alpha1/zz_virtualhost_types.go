...
type GrpcRouteActionParameters struct {
	...
	BackendGroupID *string `json:"backendGroupId" tf:"backend_group_id,omitempty"`
...
type RedirectActionParameters struct {
	...
	// +kubebuilder:validation:Optional
	ReplacePort *int64 `json:"replacePort,omitempty" tf:"replace_port,omitempty"`
...
type VirtualHostParameters struct {
	...
	// +kubebuilder:validation:Required
	HTTPRouterID *string `json:"httpRouterId" tf:"http_router_id,omitempty"`
