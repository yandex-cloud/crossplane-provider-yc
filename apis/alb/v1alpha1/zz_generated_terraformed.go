...
func (tr *BackendGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *BackendGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *BackendGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *BackendGroup) SetParameters(params map[string]interface{}) error {
...
func (tr *HTTPRouter) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *HTTPRouter) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *HTTPRouter) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *HTTPRouter) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
