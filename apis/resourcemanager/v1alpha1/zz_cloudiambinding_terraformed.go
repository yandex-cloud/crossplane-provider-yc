...
func (tr *CloudIamBinding) GetObservation() (map[string]interface{}, error) {
...
func (tr *CloudIamBinding) SetObservation(obs map[string]interface{}) error {
...
func (tr *CloudIamBinding) GetParameters() (map[string]interface{}, error) {
...
func (tr *CloudIamBinding) SetParameters(params map[string]interface{}) error {
