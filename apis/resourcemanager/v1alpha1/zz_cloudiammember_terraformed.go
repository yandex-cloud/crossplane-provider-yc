...
func (tr *CloudIamMember) GetObservation() (map[string]interface{}, error) {
...
func (tr *CloudIamMember) SetObservation(obs map[string]interface{}) error {
...
func (tr *CloudIamMember) GetParameters() (map[string]interface{}, error) {
...
func (tr *CloudIamMember) SetParameters(params map[string]interface{}) error {
